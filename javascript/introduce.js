document.addEventListener("DOMContentLoaded", () => {
    ...
    var contentStr = [
        ...
        "또 개발자는 사용자가 제품을 통해 어떤 영향을 받을지 고려해야 합니다. 저는 그저 경쟁력을 위해 다양한 기술을 개발하기보다는 사용자들이 올바르게 " +
        "활용할 수 있도록 유도하고 알려줄 수 있는 개발자가 되고 싶습니다." +
        ...
        <div class="mcText">
            ...
            &nbsp;UI는 <span class='h'>Swing</span>을 이용하여 사용자가 쉽게 이해하고 사용할 수 있도록 설계하였습니다.
            객체 설계는 메뉴의 종류와 옵션이 다양해서 어떻게 하면 <span class='h'>유지보수성과 가독성</span>을 모두 가져갈 수 있을까 고민이 많았는데
            마침 <span class='h'>Enum</span>이라는 열거형 타입을 알게되어 이를 활용하여 설계하였습니다.   
            <br><br></p>
        </div>
    </div>`,
            `<div class="mcPage">
        ...
        <div class="mcText">
            ...
            <p>&nbsp;공구리는 자바프로그래밍을 통해 진행한 첫 팀 프로젝트로 <span class='h'>Java, mariaDB, AWS 서버</span>를 활용하여 개발하였습니다.
            ...
            사용자는 로그인 후 다른 사용자가 올린 <span class='h'>공동 구매 게시글</span>을 볼 수 있으며 지역, 물품, 인원 등 다양한 조건을 필터링하거나 
            검색 기능을 통해 원하는 게시물을 쉽게 찾을 수 있습니다. 원하는 게시물을 찾으면 참여 버튼을 통해 채팅창에 참여할 수 있고 
            다른 사용자와 <span class='h'>소통하며 공동 구매에 대한 자세한 사항을 논의</span>할 수 있습니다.
