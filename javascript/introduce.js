document.addEventListener("DOMContentLoaded", () => {
    ...
    var contentStr = [
        ...
        " 이는 <span class='h'>우리만의 장난감</span>을 직접 만든 느낌이라 더욱 즐겁고 흥미를 느낄 수 있었습니다." +
        ...
        "하지만 저는 포기하지 않았고, 다양한 국내외 영상들과 블로그 포스트를 찾기 시작했습니다. 이틀 정도는 짧은 생각으로 완성된 연동 방법이 적힌 코드를 찾았습니다. " +
        "하지만 제 <span class='h'>상황에 맞는 코드를 찾기와 적용하기는 쉽지 않았습니다.</span><br><br>" +
        "<span class='icspan'># 접근법의 변화</span><br>" +
        "&nbsp;이렇게 찾는 방법은 장기적으로 도움이 되지 않으며 좋지 못한 생각인 것 같아 접근 방법을 고치기로 했습니다. " +
        "먼저 Room 라이브러리의 <span class='h'>개념부터 이해</span>하기 시작했습니다. 메소드의 기능과 필요한 인자를 분석하며 오류 발생때마다 <span class='h'>로그캣을 읽고 문제를 해결</span>했습니다. " +
        ...
        "이번 경험을 통해 <span class='h'>문제의 원인을 분석하고 해결</span>하는 능력, 어려운 문제에도 <span class='h'>포기하지 않고 끝까지 해결</span>하려는 제 열정과 끈기를 확인하며 한 걸음 성장했음을 느낄 수 있었습니다.</p>",
        // 본인 역량 - 첫 페이지
        [
            `<div class="mcPage">
