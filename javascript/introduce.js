document.addEventListener("DOMContentLoaded", () => {
    ...
    var contentStr = [
        ...
        "<p><span class='icspan'># 첫 위기와 극복</span><br>" +
        ...
        "라고 조언해 주셨습니다. 이후 저는 '공부라고 무겁게 생각하지 말고 가볍게 접근하자'라는 생각으로  집에 있던 마법천자문이라는 만화책과 영어 동화책을 읽기 시작했습니다. " +
        "신기하게도 아는 내용이 생기니 수업에도 점점 흥미를 느끼게 되었고 마침내 반에서 상위권의 성적을 받을 수 있었습니다. 이 경험을 통해 " +
        "해야 할 일에 관심이 생기지 않더라도 흥미를 끌어올릴 방법을 모색하는 것이 더 중요하다는 것을 배웠습니다.<br><br> " +
        "<span class='icspan'># 프로그래밍과의 첫 만남</span><br>" +
        "&nbsp;고등학교 때 진로 고민 중 친구의 관심사였던 프로그래밍에 처음 접하게 되었습니다. " +
        "처음에는 문법이나 변수 등 개념을 이해하는 데 어려움을 겪고 많은 흥미를 느끼지 못했지만 " +
        "프로그램 하나는 만들어보고 싶어 친구와 함께 기본적인 코딩 연습을 하며 기초를 다져갔습니다. 이후 친구들과 함께 디스코드 채널에서 이름을 입력하면 " +
        "별명, 성격 정보 등을 제공하고 벌칙 대상을 랜덤으로 뽑는 기능을 가진 봇을 만들었는데," +
        " 이때 <span class='h'>우리만의 장난감</span>을 직접 만든 느낌이라 더욱 즐겁고 흥미를 느낄 수 있었습니다." +
        " 제 취미는 그림 그리기인데 다른 사람들처럼 만화, 게임 캐릭터를 그리기보다는 인물을 창작해 그리는 것을 좋아했고 무언가를 새로 창조하는 것에 관심이 많았습니다. " +
        "개발하면서 그림 그리기와 프로그램 개발은 비슷한 맥락을 가지고 있다고 느꼈습니다. " +
        "상상하던 것을 선을 통해 그림을 완성하는 것처럼, 프로그래밍에서는 글자를 모아 프로그램을 만들어 간다는 점이 저에게 매력으로 다가왔습니다.<br><br>" +
        "<span class='icspan'># 앞으로의 목표</span><br>" +
        "&nbsp;이렇게 프로그래밍에 대해 관심이 생기고 개발을 통해 제 창의력을 극대화할 수 있겠다고 느껴 소프트웨어학과로 진학하게 되었습니다. " +
        "앞으로도 배우고 성장하며 제 아이디어를 현실로 만들어가는 과정을 즐기면서 사회에 긍정적인 영향을 미치는 개발자가 될 것입니다. " +
        "저는 좋아하는 일에는 끝없는 열정을, 싫어하는 일에는 흥미를 올릴 방법을 찾아 항상 스스로 알을 깨는 <span class='h'>병아리</span>가 될 수 있도록 노력할 것입니다.",
        ...
        "<span class='h'>더 좋은 영향을 주고 받을 수 있도록 활용하는 것</span>이 더 중요할 것입니다. <br>" +
        "&nbsp;교육 기관의 목적은 단순히 지식을 전달하는 것을 넘어 사회에 기여할 수 있는 인재를 양성하는 것입니다. " +
        "따라서 생성형 AI를 올바르게 활용하여 사고력, 어휘력, 자기결정능력 등 자신을 성장할 수 있도록 유도하는 것이 중요하다고 생각합니다. " +
        ...
        "활용할 수 있도록 유도하고 알려줄 수 있는 <span class='h'>IT 생태계 속 길잡이같은 개발자</span>가 되고 싶습니다. " +
        "최근에는 Chat GPT를 이용해 영어 회화 연습을 하는 분들이 생겼다고 합니다. 저는 이렇게 생성형 AI가 단순 편리함을 제공하는 것을 넘어 " +
        "깊은 사고와 새로운 학습 방식을 만들어 갈 잠재력을 가졌다고 생각합니다. " +
        "이러한 기술을 올바르게 활용하여 사회에 긍정적인 변화를 가져올 수 있도록 끊임없이 생각하는 개발자가 되겠습니다." +
        "</p>",
        
        
        // 프로젝트, 과제 중 느낀 점
        "<p>약 정보 제공 앱을 개발하면서 가장 기술적으로 어려웠던 부분은 외부 데이터베이스를 안드로이드 내부 로컬로 연동하는 과정이었습니다. <br><br>" +
        "<span class='icspan'># 문제의 시작</span><br>" +
        "&nbsp;저는 약 정보를 저장하기 위해 안드로이드 라이브러리인 Room DB를 이용하려고 했습니다. 하지만 Room DB에 새 데이터를 추가하는 정보는 많았지만  " +
        "외부 DB 파일을 연동하는 방법에 대한 정보는 거의 없었습니다. 안드로이드 개발 자체도 처음이라 DB 연동 여부 확인 하는 방법조차 몰라 막막한 상황이었습니다. " +
        "하지만 저는 포기하지 않았고, 다양한 국내외 영상들과 블로그 포스트를 찾기 시작했습니다. 이틀 정도는 완성된 연동 방법이 적힌 코드를 찾으며 해결하려 했지만 " +
        "제 <span class='h'>상황에 맞는 코드를 찾고 적용하기는 쉽지 않았습니다.</span><br><br>" +
        "<span class='icspan'># 접근법의 변화</span><br>" +
        "&nbsp;이렇게 단순히 코드를 찾는 방법은 장기적으로 도움이 되지 않으며 좋지 못한 접근이라는 것을 깨닫고 저는 방법을 다시 생각하기로 했습니다. " +
        "먼저 Room 라이브러리의 <span class='h'>개념부터 이해</span>하기 시작했습니다. 메소드의 기능과 필요한 인자를 분석하며 오류가 발생할 때마다 " +
        "<span class='h'>로그캣을 읽고 문제를 해결</span>했습니다. 막막할 때에는 여러 선배님들께 조언을 구하기도 했습니다. "+
        ...
        "성장을 위해서는 <span class='h'>함수의 기능과 필요한 인자를 이해해야 한다</span>는 것을 성찰하며 다시 한번 깨달았습니다. " +
        "또한 int와 Integer의 차이 등  <span class='h'>언어 기초의 부족함</span>을 느끼게 되어 다시 보완해야겠다고 결심하게 되었습니다. " +
        "이번 경험을 통해문제의 원인을 분석하고 해결하는 능력, 어려운 문제에도 포기하지 않고 끝까지 해결하려는 제 열정과 끈기를 확인하며 " +
        " <span class='h'>한 걸음 성장</span>했음을 느낄 수 있었습니다.</p>",
        // 본인 역량 - 첫 페이지
        [
            `<div class="mcPage">
